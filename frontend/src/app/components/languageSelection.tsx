    ...
    return (
        <div className="my-4">
            ...
            <select
                name="languages"
                id="languages"
                className="inline-flex w-1/2 justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-cyan-300 hover:bg-gray-50"
